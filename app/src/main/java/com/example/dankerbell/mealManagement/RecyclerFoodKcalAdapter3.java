...
public class RecyclerFoodKcalAdapter3 extends RecyclerView.Adapter<RecyclerFoodKcalAdapter3.ViewHolder> {
    private static RecyclerFoodKcalAdapter3 instance; //싱글톤
    ...
    RecyclerFoodKcalAdapter3(Context context, ArrayList<RecyclermyfoodItem> list) {
    ...
    @Override
    public RecyclerFoodKcalAdapter3.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext() ;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) ;
        View view = inflater.inflate(R.layout.food_item, parent, false) ;
        RecyclerFoodKcalAdapter3.ViewHolder vh = new RecyclerFoodKcalAdapter3.ViewHolder(view) ;
        return vh ;
    }
    ...
    @Override
    public void onBindViewHolder(final RecyclerFoodKcalAdapter3.ViewHolder holder, final int position) {
