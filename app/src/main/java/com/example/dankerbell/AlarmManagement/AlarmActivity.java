...
//                        try {
//                            mywakeupTime = sdf.parse(mywakeuptime);
//                            mymorningTime = sdf.parse(mymorningtime);
//                            mylunchTime = sdf.parse(mylunchtime);
//                            mydinnerTime = sdf.parse(mydinnertime);
//                            mysleepTime = sdf.parse(mysleeptime);
...
//       StringTokenizer token1 = new StringTokenizer(takingPillTime , ",");
//       while(token1.hasMoreTokens()) {
//           if(token1.equals("기상")) {
//               mywakeuptime = token1.toString();
//           }
//           if(token1.equals("아침")) {
//               mymorningtime = token1.toString();
//               Log.d("아침 시간", mymorningtime);
//           }
//           if(token1.equals("점심"))
//               mylunchtime = token1.toString();
//           if(token1.equals("저녁"))
//               mydinnertime = token1.toString();
//           if(token1.equals("취침"))
